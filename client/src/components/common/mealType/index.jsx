...
export const MealTypesDropDown = ({ defaultType, types, onChange, size }) => {
    ...
    return (
        <DropdownButtonImported className="dropdown-button-drop-right" drop="right" size={size} variant="info" title={mealType}>
