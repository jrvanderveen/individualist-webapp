...
export default styled.li`
    ...
    box-shadow: ${(props) =>
        props.isShoppingList || props.isGrocerySection ? "0 1px 3px rgba(0, 0, 0, .5), 0 1px 2px rgba(0, 0, 0, .5)" : "var(--box-shadow)"};
    color: #333;
    display: flex;
    justify-content: space-between;
    position: relative;
    padding: ${(props) => (props.isShoppingList ? "2.5px 5px 2.5px 5px" : props.isRecipe ? "0" : "10px")};
    margin: ${(props) => (props.isShoppingList || props.isGrocerySection ? "" : "10px 0px")};
